...
Usage:
  ...
  python bulk/compute_matrix.py --get gh/statute/act-1134/income-tax-amendment-2025/withholding-and-first-schedule-paragraph-8 --field model
...
def citation_slug(citation: str) -> str:
    ...
    gh/statute/act-1134/income-tax-amendment-2025/withholding-and-first-schedule-paragraph-8 -> uk-statute-ukpga-2003-1-681b
        ...
        out.append(
            {
                ...
                "repo": entry.get("repo", "rulespec-gh"),
